...
if __name__ == "__main__":
    ...
    pose1_bottle = [0.037, -0.069 + OBJECT_DISTANCE, 0.181 + OFFSET_BASE_TABLE, -1.573, -0.474, -0.055]  # 抓中间水瓶
    pose2_bottle = [0.037, -0.069 + OBJECT_DISTANCE, 0.231 + OFFSET_BASE_TABLE, -1.573, -0.474, -0.155]  # 抬起
    pose3_bottle = [0.037 + HOLE_DISTANCE, -0.069 + OBJECT_DISTANCE, 0.231 + OFFSET_BASE_TABLE, -1.573, -0.474,
                    -0.155]  # 抬起移到右边
    pose4_bottle = [0.034 + HOLE_DISTANCE, -0.069 + OBJECT_DISTANCE, 0.181 + OFFSET_BASE_TABLE, -1.573, -0.474,
                    -0.055]  # 放下右边
    pose5_bottle = [0.037 + HOLE_DISTANCE, -0.226 + OBJECT_DISTANCE, 0.181 + OFFSET_BASE_TABLE, -1.573, -0.474,
                    -0.155]  # 右边往后抽

    pose6_bottle = [0.037 + HOLE_DISTANCE, -0.226 + OBJECT_DISTANCE, 0.181 + OFFSET_BASE_TABLE, -1.573, -0.474,
                    -0.155]  # 瞄准右边，抓右边为pose4_bollle
    pose7_bottle = [0.037 + HOLE_DISTANCE, -0.069 + OBJECT_DISTANCE, 0.231 + OFFSET_BASE_TABLE, -1.573, -0.474,
                    -0.155]  # 右边抬起
    pose8_bottle = [0.037 + HOLE_DISTANCE, -0.226 + OBJECT_DISTANCE, 0.231 + OFFSET_BASE_TABLE, -1.573, -0.474,
                    -0.155]  # 右边抬起往后抽
    pose9_bottle = [0.037 - HOLE_DISTANCE, -0.226 + OBJECT_DISTANCE, 0.231 + OFFSET_BASE_TABLE, -1.573, -0.474,
                    -0.155]  # 抬起瞄准左边
    pose10_bottle = [0.037 - HOLE_DISTANCE, -0.069 + OBJECT_DISTANCE, 0.231 + OFFSET_BASE_TABLE, -1.573, -0.474,
                     -0.155]  # 移到左边
    pose11_bottle = [0.037 - HOLE_DISTANCE, -0.069 + OBJECT_DISTANCE, 0.181 + OFFSET_BASE_TABLE, -1.573, -0.474,
                     -0.155]  # 左边放下
    pose12_bottle = [0.037 - HOLE_DISTANCE, -0.196 + OBJECT_DISTANCE, 0.181 + OFFSET_BASE_TABLE, -1.573, -0.474,
                     -0.155]  # 左边往后抽
    pose13_bottle = [0.057, -0.226 + OBJECT_DISTANCE, 0.181 + OFFSET_BASE_TABLE, -1.573, -0.474, -0.155]  # 移到中间
    pose14_bottle = [0.057, -0.069 + OBJECT_DISTANCE, 0.181 + OFFSET_BASE_TABLE, -1.573, -0.474, -0.155]  # 中间放水位
    ...
    pose3_ball = [0.016 + HOLE_DISTANCE, -0.044 + OBJECT_DISTANCE, 0.301 + OFFSET_BASE_TABLE, 2.252, -0.901,
                  2.468]  # 抬起移到右边
    pose4_ball = [0.016 + HOLE_DISTANCE, -0.044 + OBJECT_DISTANCE, 0.221 + OFFSET_BASE_TABLE, 2.252, -0.901,
                  2.468]  # 放下右边
    pose5_ball = [0.016 + HOLE_DISTANCE, -0.044 + OBJECT_DISTANCE, 0.261 + OFFSET_BASE_TABLE, 2.252, -0.901,
                  2.468]  # 右边抬起

    pose6_ball = [0.016 - HOLE_DISTANCE, -0.226 + OBJECT_DISTANCE, 0.261 + OFFSET_BASE_TABLE, 1.568, -1.07,
                  3.042]  # 瞄准左边
    pose7_ball = [0.016 - HOLE_DISTANCE, -0.226 + OBJECT_DISTANCE, 0.261 + OFFSET_BASE_TABLE, 1.568, -1.07,
                  3.042]  # 移到左边
    pose8_ball = [0.016 - HOLE_DISTANCE, -0.044 + OBJECT_DISTANCE, 0.221 + OFFSET_BASE_TABLE, 2.268, -0.901,
                  2.448]  # 抓左边
    pose9_ball = [0.016 - HOLE_DISTANCE, -0.044 + OBJECT_DISTANCE, 0.301 + OFFSET_BASE_TABLE, 2.268, -0.901,
                  2.448]  # 左边抬起
    pose10_ball = [0.016, -0.044 + OBJECT_DISTANCE, 0.301 + OFFSET_BASE_TABLE, 2.268, -0.901, 2.448]  # 抬起移到中间

    pose11_ball = [0.016 + HOLE_DISTANCE, -0.226 + OBJECT_DISTANCE, 0.261 + OFFSET_BASE_TABLE, 1.568, -1.07,
                   3.042]  # 移到右边
    pose12_ball = [0.016 - HOLE_DISTANCE, -0.246 + OBJECT_DISTANCE, 0.261 + OFFSET_BASE_TABLE, 1.568, -1.07,
                   3.042]  # 左边往后抽
